// src/lib.rs
/*
 * Core library for ChainAnalysis
 */
...
#[derive(Debug)]
pub struct ChainAnalysisProcessor {
    verbose: bool,
    processed_count: usize,
}

impl ChainAnalysisProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting ChainAnalysis processing");
    
    let mut processor = ChainAnalysisProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = ChainAnalysisProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = ChainAnalysisProcessor::new(false);
